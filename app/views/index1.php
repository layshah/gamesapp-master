        ...
        <div class="container">
            <div class="row">
                ...
                <div style="text-align:center;" class="col-lg-5  col-sm-pull-6 col-sm-6">
                    ...
                    <a style="text-align:center;" href="https://interestship.typeform.com/to/zx5AiH" target="_blank" class="btn btn-default btn-lg"><i class="fa fa-fighter-jet fa-fw"></i> <span class="network-name">HIRE</span></a>
                  </div>
